...
\
					<h4>Wer hat die Fragen erarbeitet?</h4>\
					<p>Die Wirtschaftsjunioren anhand der angemeldeten Unternehmen</p>\
\
					<h4>Von welcher Unternehmen reden wir hier überhaupt?</h4>\
					<p>Lorem Ipsum.</p>\
\
					<h4>Wie werden die Punkte berechnet?</h4>\
					<p>Deine Antworten werden mit den vorgegebenen Antworten der Unternehmen abgeglichen.</p>\
					<ul>\
						<li>Stimmt die Antwort überein, werden dem Unternehmen 2 Punkte gutgeschrieben;</li>\
						<li>Weicht die Antwort leicht ab (Zustimmung/Neutral oder Neutral/Ablehnung), wird dem Unternehmen 1 Punkt gutgeschrieben;</li>\
						<li>Sind die Antworten entgegengesetzt oder hat eine Gruppe eine Aussagen nicht beantwortet, gibt es keine Punkte für das\
							Unternehmen.\
						</li>\
					</ul>\
					<p>Eine Aussage, die du übersprungen hast, wird nicht gewertet. Die erreichbare Höchstpunktzahl wird dadurch geringer.</p>\
					<p>Eine Aussage, die doppelt gewichtet werden soll, wird doppelt gewichtet, das heißt, für sie wird die doppelte Punktzahl\
...
\
    ...
    this.start_subtitle = "Der Ausbild-O-Mat dient zur Ermittlung der passenden Ausbildungsunternehmen.";
    this.start_explanatory_text = "<p>Der Ausbild-O-Mat ermöglicht es dir, die passenden Unternehmen für dich anhand von Fragen zu ermitteln.\
					</p>\
					<p>Dieses Tool ist eine Hilfestellung und du bist selbst verantwortlich für deine Auswahl.</p>";
    this.btn_start = "Ausbild-O-Mat starten!";
    this.btn_start_show_qa = "Fragen &amp; Antworten";
    this.btn_toggle_thesis_more_text = "Erläuterung";
    this.btn_important = "Aussage doppelt gewichten";
    this.btn_yes_text = "Trifft zu";
    this.btn_neutral_text = "Weder noch";
    this.btn_no_text = "Trifft nicht zu";
  ...
  _createClass(T, [{
    ...
    get: function get() {
      return "Aussage doppelt gewichten";
    }
  }, {
    key: "btn_thesis_has_double_weight",
    get: function get() {
      return "Aussage wird doppelt gewichtet";
    }
  }, {
